...
Route::group(['prefix' => 'api'], function()
{
    ...
    Route::post('equipos/delete/{id}', 'EquipoController@Delete');
    ...
    Route::post('torneos/delete/{id}', 'TorneoController@Delete');
    ...
    Route::post('partidos/delete/{id}', 'PartidoController@Delete');
    ...
    Route::post('zonas/delete/{id}', 'ZonaController@Delete');
    ...
    Route::post('posiciones/delete/{id}', 'PosicionController@Delete');
    ...
    Route::post('gallery/image/delete/{id}', 'GalleryController@DeleteImage');
    ...
    Route::post('noticias/delete/{id}', 'NoticiaController@Delete');
    ...
    Route::post('jugadores/delete/{id}', 'JugadorController@Delete');
});
